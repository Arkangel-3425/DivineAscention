...
{
    public class SwordofaThousandTruthsSlashPro : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                // Original offset
                Vector2 dustOffset = Projectile.rotation.ToRotationVector2() * 180f * Projectile.scale;
                ...
                Dust dust = Dust.NewDustPerfect(dustPos, DustID.BlueTorch, dustVel, 100, Color.White, 1.2f);
                dust.noGravity = true;
            ...
            // Light at tip
            Lighting.AddLight(Projectile.Center, 0.0f, 0.0f, 0.8f);
        ...
        {
            float coneLength = 185f * Projectile.scale;
        ...
        public override void CutTiles()
        {
            ...
            float swingLength = 185f * Projectile.scale;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<Voidfrost>(), 300); // 5 seconds
        ...
        private void HealTeammateThorium(Player healer, Player target, int baseHeal)
        {
            ...
            {
                Vector2 offset = Main.rand.NextVector2CircularEdge(target.width / 2f, target.height / 2f);
                Dust.NewDustPerfect(target.Center + offset, DustID.BlueTorch, Vector2.Zero, 150, Color.White, 1.2f).noGravity = true;
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            // Base slash
            Color baseColor = Color.CornflowerBlue * 0.6f * progress;
            Main.EntitySpriteDraw(slashTexture, drawPos, Utils.Frame(slashTexture, 1, 4, 0, 0),
                baseColor, drawRotation, slashOrigin, scale * 1.4f, slashEffects, 0f);

            // Glow overlay
            Color glow = Color.LightBlue * 0.9f * progress;
            Main.EntitySpriteDraw(slashTexture, drawPos, Utils.Frame(slashTexture, 1, 4, 0, 0),
                glow, drawRotation, slashOrigin, scale * 2.2f, slashEffects, 0f);
            ...
            Vector2 tipOffset = (Projectile.rotation + tipRotationOffset).ToRotationVector2() * 180f * scale;

            Main.EntitySpriteDraw(tipTexture, Projectile.Center + tipOffset - Main.screenPosition,
                null, Color.CornflowerBlue * 0.9f * progress, 0f, tipOrigin, scale, SpriteEffects.None, 0f);
