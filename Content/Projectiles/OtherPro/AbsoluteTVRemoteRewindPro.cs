...
{
    public class AbsoluteTVRemoteRewindPro : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // Stick to player (aura)
            Projectile.Center = player.Center;
            Projectile.velocity = Vector2.Zero;

            float maxRadius = 200f; // aura size
            ...
            foreach (Projectile proj in Main.projectile)
            {
                ...
                var global = proj.GetGlobalProjectile<TimeSlowGlobalProjectile>();
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D overlay = ModContent.Request<Texture2D>(
                "InfernalEclipseWeaponsDLC/Content/Projectiles/OtherPro/AbsoluteTVRemoteRewindIcon"
            ).Value;
    ...
    public class TimeSlowGlobalProjectile : GlobalProjectile
    {
        ...
        public override void PostAI(Projectile projectile)
        {
            ...
            float slowFactor = MathHelper.Lerp(1f, 0.8f, strength);
